...
class InstagramScraper(object):
    ...
    def __init__(self, **kwargs):
        default_attr = dict(username='', usernames=[], filename=None,
                            ...
                            quiet=False, maximum=100, media_metadata=True, profile_metadata=False, latest=False,
...
class DadosInstagram:
    
    def colherdados(self, user):
        ...
        parser.add_argument('--destination', '-d', default='perfis/'+user, help='Download destination')
        ...
        parser.add_argument('--proxies', default=100, help='Maximum number of items to scrape')
